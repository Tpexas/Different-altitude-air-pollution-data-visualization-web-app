<div class="flex">
    <form action="/">
        <div class="relative m-4 rounded-lg">
            ...
            <input type="text" name="search" class=" w-full pl-10 pr-20 rounded-lg z-0 focus:shadow focus:outline-none"
                placeholder="Ieškoti ataskaitų..." />
            <div class="absolute top-[5px] right-1">
                <button type="submit" class="h-8 w-20 text-white rounded-lg bg-black hover:bg-blue-500">
                    Ieškoti
                </button>
            </div>
        </div>
